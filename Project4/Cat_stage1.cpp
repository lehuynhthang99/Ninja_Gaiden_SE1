...
Cat_stage1::Cat_stage1()
{
}

Cat_stage1::Cat_stage1(string Path, int x, int y, int Width, int Height, int frameNumber, int animDelay, string fileName, 
...
void Cat_stage1::UpdatePosition()
{
	sprite._X += _vx;
}

void Cat_stage1::UpdateFrame()
{
...
LPEnemy Cat_stage1::Update(Ryu * ryu)
{
...
Box Cat_stage1::ToBox()
{
	return Enemy::ToBox();
}

void Cat_stage1::Render(Camera camera)
{
	if (_died == -1)
	{
		Enemy::Render(camera);
